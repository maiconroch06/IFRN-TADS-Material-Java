...
public class Gerenciamento {
    ...
    public boolean verificarFuncionario(String CPF, Funcionario funcionario) {
    ...
    public boolean verificarCliente(String CPF, Cliente cliente){
    ...
    public boolean verificarProduto(String codigo, Produto produto) {
    ...
    public boolean verificarVenda(String ID_Venda, Venda venda){        
    ...
    public void cadastrarVenda(String ID_Venda, Venda venda){        
