...
public class PeLivro extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Tela de Cadastro de Livro");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        String CDU = jTextField1.getText().trim();
        String ISBN = jTextField2.getText().trim();
        String titulo = jTextField3.getText().trim();
        String autor = jTextField4.getText().trim();
        String editora = jTextField5.getText().trim();
        String anoPublicacao = jFormattedTextField1.getText().trim();

        try {
            // 1. Verifica se algum campo está vazio
            if (CDU.isEmpty() || ISBN.isEmpty() || titulo.isEmpty() || autor.isEmpty() 
                    || editora.isEmpty() || anoPublicacao.isEmpty()) {
            ...
            // 3. Seta os valores dentro do objeto Livro
            novoLivro.setCDU(CDU);
